...
class Application:
    def __init__(self, master=None):
        ...
        self.eigthContainer = Frame(master)
        self.eigthContainer["padx"] = 20
        self.eigthContainer["pady"] = 10
        self.eigthContainer.pack()
        ...
        self.title = Label(self.primaryContainer, text="Dados iniciais da lixeira")
        self.title["font"] = ("Arial", "10", "bold")
        self.title.pack()

        self.idLabel = Label(self.eigthContainer,text="Id", font=self.fontePadrao, width=20)
        self.idLabel.pack(side=LEFT)

        self.id = Entry(self.eigthContainer)
        self.id.insert(0, "1")
        self.id["width"] = 25
        ...
        self.cordXLabel = Label(self.fourthContainer, text="Coordinate X", font=self.fontePadrao, width=20)
        ...
        self.cordYLabel = Label(self.fifthContainer, text="Coordinate Y", font=self.fontePadrao,  width=20)
        ...
        self.capacityLabel = Label(self.sixthContainer, text="Capacity (M³)", font=self.fontePadrao,  width=20)
    ...
    def createTrash(self):
        ...
        try:
            self.lixeira = Lixeira(int(id),host,int(port),int(cordX),int(cordY),int(capacity))
            self.message["text"] =self.lixeira.start()
